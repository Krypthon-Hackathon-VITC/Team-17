...
const Contact = () => {
  return (
    <div id="contact">
        <footer className="text-center lg:text-left bg-green-900 text-green-100 border-green-200">
  <div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
    ...
    <div className="flex justify-center items-center">
      ...
      <a href="https://www.instagram.com/happyclubvitc/?igshid=YmMyMTA2M2Y=" className="lg:mr-6 text-gray-600" target="_blank">
  ...
  <div className="mx-6 py-10 text-center md:text-left">
    ...
    <path fill="currentColor" d="M493.4 24.6l-104-24c-11.3-2.6-22.9 3.3-27.5 13.9l-48 112c-4.2 9.8-1.4 21.3 6.9 28l60.6 49.6c-36 76.7-98.9 140.5-177.2 177.2l-49.6-60.6c-6.8-8.3-18.2-11.1-28-6.9l-112 48C3.9 366.5-2 378.1.6 389.4l24 104C27.1 504.2 36.7 512 48 512c256.1 0 464-207.5 464-464 0-11.2-7.7-20.9-18.6-23.4z">
        ...
        <p>
        <ul className='p-2 flex flex-wrap justify-center items-center'>
<li className='p-2'>

Helpline 1 - Person1  <br></br>
M No. - 9179582143
</li >
<li className='p-2'>
HelpLine 2- Person2  <br></br>
M No. - 9161483463
</li>
  ...
  <div className="text-center p-6 bg-green-100 text-green-900">
    <span>©Copyright:</span>
    <a className=" font-semibold" href="https://tailwind-elements.com/">Krishiaan</a>
  </div>
</footer>
